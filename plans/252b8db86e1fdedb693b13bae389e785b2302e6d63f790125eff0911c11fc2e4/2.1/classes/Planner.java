public class Planner {
    ...
    private static void processIssues() {
        ...
        String repoPath = checkoutCodeFromGitHub(issueId);
    ...
    private static String checkoutCodeFromGitHub(String issueId) {
        // Stub: Checkout relevant code from GitHub
        return PlanningToolStubs.read_file_advanced("github/repo", null, "git", null, false).get("content").toString();
    }
